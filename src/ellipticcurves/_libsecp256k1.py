...
answer with `ELLIPTICCURVES_NO_LIBSECP256K1` applied -- installed, and not
...
# them, read once and here: a caller settling it after `import
# ellipticcurves` would be settling it after this module has answered.
# The package's name as its prefix, and "set to ask for it": an empty
# value is not set, so `ELLIPTICCURVES_NO_LIBSECP256K1=` leaves them
# serving
NO_LIBSECP256K1 = "ELLIPTICCURVES_NO_LIBSECP256K1"
