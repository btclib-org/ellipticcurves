...
def _recover_pub_key_(
    ...
    if prime_order:
        ...
        # written out: this is the arm it did not cover. What the multiplication
        # also bought was a cross-check of 1.6.1 -- issue btclib-org/btclib#183
        # was the two implementations disagreeing while each held its own copy
        # of this arithmetic -- and that guarantee is the suite's now, where it
        # already lives: the bindings are the authority this path is held
        # against, candidate by candidate and key_id by key_id (issue
        # btclib-org/btclib#890)
        return QJ
