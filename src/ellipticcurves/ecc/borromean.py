...
issue btclib-org/btclib#1070 found the message and the point swapped, and every
...
there alike, and RELEASE_NOTES.md's breaking-changes list has what settling on
this one cost.
