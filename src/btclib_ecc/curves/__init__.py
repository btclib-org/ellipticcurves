...
"""Module btclib_ecc.curves.

**The arithmetic.** btclib_ecc.curves holds the elliptic curve itself: the
...
What is built *on* a curve lives in btclib_ecc.ecc -- dsa, ssa, borromean,
...
so the anchor is worth stating: `from btclib_ecc.curves import mult`, `from
btclib_ecc.ecc import dsa`.
...
The other multiplications of btclib_ecc.curves.curve_group and
btclib_ecc.curves.curve_group_2 -- _mult_aff_var, _mult_jac_var,
...
from btclib_ecc.curves.curve_group import CurveGroup
