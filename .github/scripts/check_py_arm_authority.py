...
called. Nothing else re-runs that measurement: a test module that stops
exercising an arm keeps the arm's entry, and the claim goes stale on an
otherwise green suite (issue btclib-org/btclib#1003).
